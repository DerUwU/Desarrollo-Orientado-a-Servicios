...
_a = ProgramaDAO;
ProgramaDAO.obtenerProgramas = (sqlConsulta, parameters, res) => __awaiter(void 0, void 0, void 0, function* () {
...
ProgramaDAO.crearProgrmas = (sqlCrear, parameters, res) => __awaiter(void 0, void 0, void 0, function* () {
...
ProgramaDAO.encontrarPorID = (sqlCrear, parameters, res) => __awaiter(void 0, void 0, void 0, function* () {
    yield conexionDB_1.default.one(sqlCrear, parameters)
        .then((dato) => {
        console.log(dato);
...
ProgramaDAO.eliminarPorID = (sqlCrear, parameters, res) => __awaiter(void 0, void 0, void 0, function* () {
